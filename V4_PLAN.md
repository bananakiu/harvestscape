...
| **mastery trials at 50** (remaining v4.1 story) | The 50-gate trial per skill (all six), each set by the craft's caring NPC. Deferred from v4.3/v4.4 — touches every skill's progression, wants its own release. |
