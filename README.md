...
- **RuneScape-style progression, a kinder curve** — 5 skills trained 1→99 on a bespoke XP curve tuned for cozy play (rewarding early, a real climb through the middle, only the last few levels a completionist grind — no 13-million-XP wall), level-gated content (crops, trees, ores, fish, and a full Cooking recipe ladder), mastery perks at 25/50/75/99 — and when you hit one, the neighbour who cares most about that craft says a warm word. Four tiers of upgradeable tools (Basic → Copper → Iron → Gold).
