...
- **Cozy, opt-in combat (v4 "The Tenth Door")** — **Warding**, a sixth 1→99 skill: below the valley the dark has knotted itself into *restless things* (gloam wisps, knot-shamblers, ember mites) you **settle** — not slay — with a forged Warden's Stave. Every attack is telegraphed; defeat is a soft knockout that wakes you safe at the door with **everything still yours** (nothing is ever taken — the cozy contract holds). It lives only in the Undercroft; the whole rest of the valley stays hazard-free. Settling drops feed charms and Pledge-Ledger bell checkpoints; a daily **variety spark** rewards rotating your crafts.
