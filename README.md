...
- **Cozy, opt-in combat (v4 "The Tenth Door" / "The Great Knot")** — **Warding**, a sixth 1→99 skill: below the valley the dark has knotted itself into *restless things* you **settle** — not slay — with a forged Warden's Stave, down thirty floors of the Undercroft. Five families band by depth (gloam wisps, knot-shamblers, ember mites, then the **Hollow Warden** that guards its front so you must circle it, and the **Gloam Tangle** that splits when struck), and every tenth floor a **Great Knot** boss guards the descent with two telegraphed moves. Every attack is telegraphed, health bars and numbered hitsplats read the fight, and defeat is a soft knockout that wakes you safe at the door with **everything still yours** (nothing is ever taken — the cozy contract holds). It lives only in the Undercroft; the whole rest of the valley stays hazard-free. Settling drops feed charms and Pledge-Ledger bell checkpoints; a daily **variety spark** rewards rotating your crafts.
