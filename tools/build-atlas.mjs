...
const MAP_ACCESS = {
  ...
  undercroft: "Behind the planked tenth door in the Guild, opened by 'The Tenth Door' (Act III; needs Act II done + total level 100). The Warden's wing, sealed eleven years — floors 1–15 of cozy-dark cavern, knotted with restless things you SETTLE with the Stave (never kill; nothing is ever taken, knockout costs zero). The way down hides under a knot on each floor; a Warden's Bell every 5th floor is a Pledge-Ledger checkpoint you can ring back down to. Time stands still, like the mine. The only hazardous space in the valley — and only because you walk into it.",
